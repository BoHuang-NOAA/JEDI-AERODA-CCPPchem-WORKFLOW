...
# - orig if [ -f $gmemdir/RESTART/${sPDY}.${scyc}0000.coupler.res ]; then
# - orig   export warm_start=".true."
# - orig fi
gesln_clean="NO"
tracer_da2fcst="YES"
...
# -orig         $NCP $file $memdir/RESTART/$file
         $NMV ${file} $memdir/RESTART/${file}.ges
       done
     fi
    done
